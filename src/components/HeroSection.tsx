          ...
          <div className="flex-1 text-center lg:text-left">
            <div className="inline-block mb-4">
              <div className="flex items-center gap-3 mb-4">
                <img src="/media/logo.png" alt="Glyph Notes Logo" className="w-10 h-10" />
            ...
            <hr style={{ borderColor: '#FFFFFF40', borderWidth: '1px', width: '45%' }} />
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-montserrat font-extrabold font-light my-6">
